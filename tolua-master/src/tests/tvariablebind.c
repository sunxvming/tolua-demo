...
LUALIB_API int luaopen_tvariable (lua_State* tolua_S);
...
static int tolua_get_A_A_i(lua_State* tolua_S)
{
...
static int tolua_set_A_A_i(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
static int tolua_get_A_A_f(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
static int tolua_set_A_A_f(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
...
static int tolua_get_A_A_d(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
static int tolua_set_A_A_d(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
...
static int tolua_get_A_A_s(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
static int tolua_set_A_A_s(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
...
static int tolua_get_A_A_v(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
static int tolua_set_A_A_v(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
...
static int tolua_get_A_A_n(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
static int tolua_set_A_A_n(lua_State* tolua_S)
{
  A* self = (A*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
...
static int tolua_get_B_B_a(lua_State* tolua_S)
{
...
static int tolua_set_B_B_a(lua_State* tolua_S)
{
  B* self = (B*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
...
static int tolua_get_B_B_b_ptr(lua_State* tolua_S)
{
  B* self = (B*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
static int tolua_set_B_B_b_ptr(lua_State* tolua_S)
{
  B* self = (B*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
...
static int tolua_get_U_U_i(lua_State* tolua_S)
{
...
static int tolua_set_U_U_i(lua_State* tolua_S)
{
  U* self = (U*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
...
static int tolua_get_U_U_f(lua_State* tolua_S)
{
  U* self = (U*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'f'",NULL);
...
static int tolua_set_U_U_f(lua_State* tolua_S)
{
  U* self = (U*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
...
LUALIB_API int luaopen_tvariable (lua_State* tolua_S)
{
 ...
 tolua_variable(tolua_S,"i",tolua_get_A_A_i,tolua_set_A_A_i);
 tolua_variable(tolua_S,"f",tolua_get_A_A_f,tolua_set_A_A_f);
 tolua_variable(tolua_S,"d",tolua_get_A_A_d,tolua_set_A_A_d);
 tolua_variable(tolua_S,"s",tolua_get_A_A_s,tolua_set_A_A_s);
 tolua_variable(tolua_S,"v",tolua_get_A_A_v,tolua_set_A_A_v);
 tolua_variable(tolua_S,"n",tolua_get_A_A_n,tolua_set_A_A_n);
 tolua_endmodule(tolua_S);
 tolua_cclass(tolua_S,"B","B","",NULL);
 tolua_beginmodule(tolua_S,"B");
 tolua_variable(tolua_S,"a",tolua_get_B_B_a,tolua_set_B_B_a);
 tolua_variable(tolua_S,"b",tolua_get_B_B_b_ptr,tolua_set_B_B_b_ptr);
 tolua_endmodule(tolua_S);
 tolua_cclass(tolua_S,"U","U","",NULL);
 tolua_beginmodule(tolua_S,"U");
 tolua_variable(tolua_S,"i",tolua_get_U_U_i,tolua_set_U_U_i);
 tolua_variable(tolua_S,"f",tolua_get_U_U_f,tolua_set_U_U_f);
 tolua_endmodule(tolua_S);
...
TOLUA_API int tolua_tvariable_open (lua_State* tolua_S)
{
 lua_pushcfunction(tolua_S, luaopen_tvariable);
 lua_pushstring(tolua_S, "tvariable");
